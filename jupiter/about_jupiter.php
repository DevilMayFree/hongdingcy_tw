...
<link rel='canonical' href='https://www.cgsice.com/jupiter/about_jupiter.php' />
<link rel='shortlink' href='' />
	<title>關於Jupiter先機｜Jupiter先機</title>
  <meta name='title' content='關於Jupiter先機｜Jupiter先機' />
	<meta name='description' content='' />
	<meta name='keywords' content='' />
	<meta name='sitecode' content='zh-TW'> <!--動態產生-->

	<!--Line-->
	<meta itemprop='name' content='關於Jupiter先機｜Jupiter先機'>
	<meta itemprop='url' content='https://www.cgsice.com/jupiter/about_jupiter.php'>
	...
	<!--FB-->
	<meta property='og:title' content='關於Jupiter先機｜Jupiter先機'>
	<meta property='og:type' content='website'>	
	<meta property='og:url' content='https://www.cgsice.com/jupiter/about_jupiter.php'>
...
<script src="js/main.js" defer></script>    <link rel="stylesheet" href="css/about.css?ver=1639710965">
</head>
<body>
    <div id="header_outer">
    <header>
...
</div>    <div id="banner" style="background-image: url(img/about-j/01_banner.jpg);">
    ...
    <div class="inner w1200 txt-white">
        <div class="text">
            <h2 class="h1 txt-bold" id="banner_title">關於Jupiter先機</h2>
            <h5>Jupiter 先機是一間積極型專業基金管理公司，時刻堅守投資理念， 致力協助客戶實現長期投資目標。</h5>
        </div>
    </div>
</div>
    <section id="about">
        <div class="text_block main_padding">
            <div class="inner w1200">
                <h2 class="title txt-theme">
                    Jupiter先機簡介
                </h2>
                <p>
                    Jupiter 先機自 1985 年成立至今，一直堅守投資理念，以靈活積極的基金管理方針，協助客戶實現長期投資目標，為客戶締造投資回報。
                    <br><br>
                    在成立的時候，我們就明白，要達到以上目標，需要建立與眾不同、具備企業家精神的公司文化，並廣泛運用在所有業務領域上。Jupiter 先機團隊人才濟濟，渴望在市場中脫穎而出，成為管理客戶資產的可靠之選。作為基金公司，面對市場的激烈競爭，Jupiter 先機希望客戶能體驗公司的活力及專注力，並能充分感受這些獨特優勢，從中受惠。
                    <br><br>
                    時至今日，經過 35 年的努力，我們已成為英國的領先資產管理公司之一，這正是因為我們在發展業務期間，時刻保持一貫的靈活及衝勁。我們多年來的價值，建立於優秀的人才，且能因應瞬息萬變的投資市場，並時刻勇於迎接挑戰，致力為客戶締造最佳投資回報。
                </p>
            </div>
        </div>
        ...
        <div class="col_block">
            <div class="text">
                <div class="in-left">
                    <h2 class="title txt-theme">業務發展以客為先</h2>
                    <br>
                    <p>
                        我們認為公司在發展業務時必須以客為先，才能長期蓬勃發展。在與客戶溝通期間，會採取主動式，不論何時都以客戶的利益為先，才可達到可觀、長遠淨收益的服務承諾。
                        <br><br>
                        我們時時刻刻都與客戶緊密聯繫，向他們分享多項資訊，包括我們的獨特投資文化、我們的系統及投資程序，如何好好利用投資項目，以及商業策略。客戶的利益始終是我們的最終的任務。
                        <br><br>
                        這說法充分展現了以客為先的精神，且深植在我們的基金團隊中，也是 Jupiter 先機的動力來源。
                    </p>  
                </div>
            </div>
            <figure style="background-image: url(img/about-j/car.jpg);"></figure>
        </div>
        ...
        <div class="text_block main_padding">
            <div class="inner w1200">
                ...
                <h5 class="h5-27">
                    Jupiter 先機與眾不同、具企業家精神的公司文化乃建立於我們為投資專才提供合作環境，並賦予他們靈活的投資風格。
                </h5>
                <br>
                <p>
                    我們認為公司在發展業務時必須以客為先，才能長期蓬勃發展。在與客戶溝通期間，會採取主動式，不論何時都以客戶的利益為先，才可達到可觀、長遠淨收益的服務承諾。
    ...
    <section id="award" class="main_padding">
        <div class="w1200">
            <h2 class="title txt-theme txt-center">基金得獎紀錄</h2>

            <div class="year txt-theme">
                <div class="year_container swiper-container">
                    <div class="swiper-wrapper">
                        <!--                         <div class="year_item swiper-slide active" data-year="2019">
                            <h5 class="txt-medium">
                                <span>
                                    2019                                </span>
                            </h5>
                        </div>
                                                <div class="year_item swiper-slide " data-year="2018">
                            <h5 class="txt-medium">
                                <span>
                                    2018                                </span>
                            </h5>
                        </div>
                                                <div class="year_item swiper-slide " data-year="2017">
                            <h5 class="txt-medium">
                                <span>
                                    2017                                </span>
                            </h5>
                        </div>
                                                <div class="year_item swiper-slide " data-year="2016">
                            <h5 class="txt-medium">
                                <span>
                                    2016                                </span>
                            </h5>
                        </div>
                                                <div class="year_item swiper-slide " data-year="2015">
                            <h5 class="txt-medium">
                                <span>
                                    2015                                </span>
                            </h5>
                        </div>
                                                <div class="year_item swiper-slide " data-year="2014">
                            <h5 class="txt-medium">
                                <span>
                                    2014                                </span>
                            </h5>
                        </div>
                                                <div class="year_item swiper-slide " data-year="2013">
                            <h5 class="txt-medium">
                                <span>
                                    2013                                </span>
                            </h5>
                        </div>
                                                <div class="year_item swiper-slide " data-year="2012">
                            <h5 class="txt-medium">
                                <span>
                                    2012                                </span>
                            </h5>
                        </div>
                                                <div class="year_item swiper-slide " data-year="2011">
                            <h5 class="txt-medium">
                                <span>
                                    2011                                </span>
                            </h5>
                ...
                <div class="to_left">
                    <img src="img/public/arrow_left.svg" alt="">
                </div>
                <div class="to_right">
                    <img src="img/public/arrow_left.svg" alt="">
                </div>
            ...
            <div class="award_box">
                <!-- <div class="award_item">
                    <h5 class="txt-medium h5-27">先機亞太股票基金</h5>
                    <h6>Citywire最佳基金獎(香港)</h6>
                    <br>
                    <h6>亞太股票(日本除外)</h6>
                </div> -->
            </div>
            ...
            <small>
                資料來源：台灣金鑽獎、理柏基金獎、Smart智富台灣基金獎、晨星年度最佳基金獎、Money Observer Fund Award、《指標》年度台灣基金大獎，Citiwire，2019年4月
                <br>
                1先機大中華股票基於2015年11月19日更名為先機中國基金
                <br>
                2先機環球債券基金於2017年8月24日更名為先機環球策略債券基金(基金之配息來源可能為本金)且已於2019年4月25日進行清算
                <br>
                3先機瑞士股票基金已於2013年10月16日進行清算
                <br>
                4先機完全回報美元債券基金於2019年4月25日更名為先機環球動態債券基金(本基金名稱原先為先機完全回報美元債券基金)(基金之配息來源可能為本金)
            </small>
        </div>
    </section>
    ...
    <div class="content w1400">
        ...
        <div class="content_bottom">
            <div class="item">
                ...
                <p>客服信箱：<a href="/cdn-cgi/l/email-protection#77041205011e1412371410041e14125914181a" class="txt-orange"><span class="__cf_email__" data-cfemail="02716770746b6167426165716b61672c616d6f">[email&#160;protected]</span></a></p>

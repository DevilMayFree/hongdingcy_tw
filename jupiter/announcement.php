...
<link rel='canonical' href='https://www.cgsice.com/jupiter/announcement.php' />
<link rel='shortlink' href='' />
	<title>公告｜Jupiter先機</title>
  <meta name='title' content='公告｜Jupiter先機' />
	<meta name='description' content='' />
	<meta name='keywords' content='' />
	<meta name='sitecode' content='zh-TW'> <!--動態產生-->

	<!--Line-->
	<meta itemprop='name' content='公告｜Jupiter先機'>
	<meta itemprop='url' content='https://www.cgsice.com/jupiter/announcement.php'>
	...
	<!--FB-->
	<meta property='og:title' content='公告｜Jupiter先機'>
	<meta property='og:type' content='website'>	
	<meta property='og:url' content='https://www.cgsice.com/jupiter/announcement.php'>
...
<body>
    ...
    <div class="inner w1200 txt-white">
        <div class="text">
            <h2 class="h1 txt-bold" id="banner_title">公告</h2>
            <h5></h5>
        </div>
    </div>
</div>    <section id="announcement" class="main_padding">
        <div class="inner w1200">
            ...
            <div class="itembox" id="show_list">
                <!-- 列表開始 -->
                <!-- <a href="announcement_info.php" class="item">
                    <div class="tag_block">
                        <small class="tag">
                            公告
                        </small>
                    </div>
                    <p class="date txt-theme">
                        2021.08.12
                    </p>
                    <p class="text txt-bold txt-theme">
                        【公告】110年5月份休假日
                    </p>
                </a> -->
                <!-- 列表結束 -->
    ...
    <div class="content w1400">
        ...
        <div class="content_bottom">
            <div class="item">
                ...
                <p>客服信箱：<a href="/cdn-cgi/l/email-protection#186b7d6a6e717b7d587b7f6b717b7d367b7775" class="txt-orange"><span class="__cf_email__" data-cfemail="bac9dfc8ccd3d9dffad9ddc9d3d9df94d9d5d7">[email&#160;protected]</span></a></p>
...
<!-- ////////// END FOOTER ////////// -->    <script data-cfasync="false" src="/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script type="text/javascript">
     $("body").on("click","#get_more",function(){
    	...
    	//alert(data_type);
    	//alert(page);
    	$.post("get_announcement_list.php",{page:page},function(data){
    		d=JSON.parse(data);
    		if(d["content"])
    		{
    			if(more_btn=="Y")

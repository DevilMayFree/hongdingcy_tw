...
<link rel='canonical' href='https://www.cgsice.com/jupiter/document_equityfunds.php' />
<link rel='shortlink' href='' />
	<title>資料下載｜Jupiter先機</title>
  <meta name='title' content='資料下載｜Jupiter先機' />
	<meta name='description' content='' />
	<meta name='keywords' content='' />
	<meta name='sitecode' content='zh-TW'> <!--動態產生-->

	<!--Line-->
	<meta itemprop='name' content='資料下載｜Jupiter先機'>
	<meta itemprop='url' content='https://www.cgsice.com/jupiter/document_equityfunds.php'>
	...
	<!--FB-->
	<meta property='og:title' content='資料下載｜Jupiter先機'>
	<meta property='og:type' content='website'>	
	<meta property='og:url' content='https://www.cgsice.com/jupiter/document_equityfunds.php'>
...
<script src="js/main.js" defer></script>    <link rel="stylesheet" href="css/download.css?ver=1639710965">
...
<body>
    ...
    <div class="page_tabs">
        	        <a href="document_equityfunds.php" id="type22" class="tab active" data-pic="https://www.cgsice.com/jupiter/img/funds/01_banner2.jpg" data-type="22">
	            <h5 class="txt-bold txt-theme">股票型基金</h5>
	        </a>
          	        <a href="document_bondfunds.php" id="type21" class="tab " data-pic="https://www.cgsice.com/jupiter/img/funds/01_banner.jpg" data-type="21">
	            <h5 class="txt-bold txt-theme">債券型基金</h5>
	        </a>
                  <!-- <a href="#" class="tab" data-pic="img/funds/01_banner2.jpg">
            <h5 class="txt-bold txt-theme">股票型基金</h5>
        </a> -->
    </div>
    ...
    <section id="download" class="main_padding">
        <div class="inner w1200">
            <div class="itembox" id="show_list">
                	                <div class="item">
	                    <div class="top">
	                        <h5 class="h5-27 txt-medium txt-theme">
	                            先機北美股票基金	                            <span class="txt-dark_gray">
	                                	                            </span>
	                        </h5>
	                        <a href="javascript:void(0)" class="dw_all" id="dw_all1" data-sn="1"><img src="img/public/download.svg" alt=""></a>
	                        <a hrf="javascript:void(0)" class="show_dw_list"><img src="img/public/drop_down1.svg" alt=""></a>
	                    </div>
	                    <div class="bottom">
	                        <a href="" download class="sub">
	                    ...
	                    <div class="top">
	                        <h5 class="h5-27 txt-medium txt-theme">
	                            先機環球股票基金	                            <span class="txt-dark_gray">
	                                	                            </span>
	                        </h5>
	                        <a href="javascript:void(0)" class="dw_all" id="dw_all4" data-sn="4"><img src="img/public/download.svg" alt=""></a>
	                        <a hrf="javascript:void(0)" class="show_dw_list"><img src="img/public/drop_down1.svg" alt=""></a>
	                    </div>
	                    <div class="bottom">
	                        <a href="" download class="sub">
	                    ...
	                    <div class="top">
	                        <h5 class="h5-27 txt-medium txt-theme">
	                            先機全球新興市場基金	                            <span class="txt-dark_gray">
	                                	                            </span>
	                        </h5>
	                        <a href="javascript:void(0)" class="dw_all" id="dw_all8" data-sn="8"><img src="img/public/download.svg" alt=""></a>
	                        <a hrf="javascript:void(0)" class="show_dw_list"><img src="img/public/drop_down1.svg" alt=""></a>
	                    </div>
	                    <div class="bottom">
	                        <a href="" download class="sub">
	                    ...
	                    <div class="top">
	                        <h5 class="h5-27 txt-medium txt-theme">
	                            先機中國基金	                            <span class="txt-dark_gray">
	                                	                            </span>
	                        </h5>
	                        <a href="javascript:void(0)" class="dw_all" id="dw_all9" data-sn="9"><img src="img/public/download.svg" alt=""></a>
	                        <a hrf="javascript:void(0)" class="show_dw_list"><img src="img/public/drop_down1.svg" alt=""></a>
	                    </div>
	                    <div class="bottom">
	                        <a href="" download class="sub">
	                    ...
	                    <div class="top">
	                        <h5 class="h5-27 txt-medium txt-theme">
	                            先機亞太股票入息基金	                            <span class="txt-dark_gray">
	                                	                            </span>
	                        </h5>
	                        <a href="javascript:void(0)" class="dw_all" id="dw_all10" data-sn="10"><img src="img/public/download.svg" alt=""></a>
	                        <a hrf="javascript:void(0)" class="show_dw_list"><img src="img/public/drop_down1.svg" alt=""></a>
	                    </div>
	                    <div class="bottom">
	                        <a href="" download class="sub">
    ...
    <div class="content w1400">
        ...
        <div class="content_bottom">
            <div class="item">
                ...
                <p>客服信箱：<a href="/cdn-cgi/l/email-protection#81f2e4f3f7e8e2e4c1e2e6f2e8e2e4afe2eeec" class="txt-orange"><span class="__cf_email__" data-cfemail="b0c3d5c2c6d9d3d5f0d3d7c3d9d3d59ed3dfdd">[email&#160;protected]</span></a></p>
...
<!-- ////////// END FOOTER ////////// -->    <iframe name=iframe1 cellspacing=0 src='' style='border:none;display:none' width=0 height=0 border=0  frameborder='0'></iframe><script data-cfasync="false" src="/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script></body>
<script>
    $("body").on('click',".item .show_dw_list",function(){
        $(this).parent().next('.bottom').toggleClass('active');
    });
</script>
<script type="text/javascript">
	$("body").on("click",".page_tabs .tab",function(){
		var my_btn=$(this);
		var type=my_btn.data("type");
		$.post("get_download_list.php",{type:type},function(data){
			if(data)
			{
				$("#show_list").html(data);
			}
	...
	$("body").on("click",".dw_all",function(){
		var my_btn=$(this);
		var sn=my_btn.data("sn");
		iframe1.location.href='dw_all_file.php?sn='+sn;
	})
	$(document).ready(function(){
		$("#type22").trigger("click");
	})
</script>
</html>
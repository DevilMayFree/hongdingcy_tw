...
<link rel='canonical' href='https://www.cgsice.com/jupiter/insights_list.php' />
<link rel='shortlink' href='' />
	<title>投資觀點｜Jupiter先機</title>
  <meta name='title' content='投資觀點｜Jupiter先機' />
	<meta name='description' content='' />
	<meta name='keywords' content='' />
	<meta name='sitecode' content='zh-TW'> <!--動態產生-->

	<!--Line-->
	<meta itemprop='name' content='投資觀點｜Jupiter先機'>
	<meta itemprop='url' content='https://www.cgsice.com/jupiter/insights_list.php'>
	...
	<!--FB-->
	<meta property='og:title' content='投資觀點｜Jupiter先機'>
	<meta property='og:type' content='website'>	
	<meta property='og:url' content='https://www.cgsice.com/jupiter/insights_list.php'>
...
<script src="js/main.js" defer></script>    <link rel="stylesheet" href="css/insights.css?ver=1639710965">
</head>
<body>
    <div id="header_outer">
    <header>
...
</div>    <div id="banner" style="background-image: url(img/insights/01_banner.jpg);">
        <div class="w1200" style="padding-top: 20px">
            <p class="txt-white">
	            ...
	            <div class="text">
	                <p>11.04.2024</p>
	                <h2>央行可能需要採取更加鴿派的展望</h2>
	                <br><br>
	                <a href="insights_info.php?sn=129" class="btn">
	                    了解更多
    ...
    <div class="page_filter main_padding">
        <div class="w1200">
            <form name="form1" id="form1" class="inner" style="justify-content: center;">
                <div class="col col33">
                	                    <p class="txt-bold txt-orange flex-sb">
                        以資產類別分類
                        <span class="small txt-medium txt-dark">
                            <span id="show_check_amount">0</span>/2                        </span>
                    </p>
                    <select name="data_type" id="classification" multiple="multiple" class="multiple-select"  placeholder="請選擇">
                    	                        	<option value="債券型" selected>債券型</option>
                    			                    		                        	<option value="股票型" selected>股票型</option>
                    			                    		                    </select>
                </div>
    ...
    <section id="insights" class="main_padding">
        <div class="inner w1200">
            <div class="itembox" id="show_list">
            		<!-- 列表開始 -->
                <!-- <a href="insights_info.php" class="insights-item">
                    <figure style="background-image: url(img/index/04_1.jpg);"></figure>
                    <div class="text">
                        <h5 class="h5-27">
                            【先機觀點】全球新興市場 - 逢低適時加碼高成長類股
                        </h5>
                        <p class="in">
                            中國武漢肺炎疫情於春節期間爆發，為全球金融市場....
                        </p>
                        <p class="date txt-gray txt-right">14.04.2021</p>
                    </div>
                </a> -->
                <!-- 列表結束 -->
            </div>
    ...
    <div class="content w1400">
        ...
        <div class="content_bottom">
            <div class="item">
                ...
                <p>客服信箱：<a href="/cdn-cgi/l/email-protection#4d3e283f3b242e280d2e2a3e242e28632e2220" class="txt-orange"><span class="__cf_email__" data-cfemail="4b382e393d22282e0b282c3822282e65282426">[email&#160;protected]</span></a></p>
...
<script>
    $('#classification').multipleSelect();
    $("body").on("change","#classification",function(){
    	var my_btn=$(this);
    	var data_type=my_btn.val();
    	var chk_n=$("#classification :selected");
    	$("#show_check_amount").html(chk_n.length);
    	var more_btn=$("#more_btn").val();
    	if(more_btn!="Y")$("#page").val("1");
    	var page=$("#page").val();
    	//alert(data_type);
    	//alert(page);
    	$.post("get_insight_list.php",{data_type:data_type,page:page},function(data){
    		d=JSON.parse(data);
    		if(d["content"])
    		{
    			if(more_btn=="Y")

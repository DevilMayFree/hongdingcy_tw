...
<link rel='canonical' href='https://www.cgsice.com/jupiter/market_weeklyreport.php' />
<link rel='shortlink' href='' />
	<title>市場快訊｜Jupiter先機</title>
  <meta name='title' content='市場快訊｜Jupiter先機' />
	<meta name='description' content='' />
	<meta name='keywords' content='' />
	<meta name='sitecode' content='zh-TW'> <!--動態產生-->

	<!--Line-->
	<meta itemprop='name' content='市場快訊｜Jupiter先機'>
	<meta itemprop='url' content='https://www.cgsice.com/jupiter/market_weeklyreport.php'>
	...
	<!--FB-->
	<meta property='og:title' content='市場快訊｜Jupiter先機'>
	<meta property='og:type' content='website'>	
	<meta property='og:url' content='https://www.cgsice.com/jupiter/market_weeklyreport.php'>
...
<script src="js/main.js" defer></script>    <link rel="stylesheet" href="css/market.css?ver=1639710966">
</head>
<body>
    <div id="header_outer">
    <header>
...
</div>    <div id="banner" style="background-image: url(img/market/01_banner.jpg);">
    ...
    <div class="inner w1200 txt-white">
        <div class="text">
            <h2 class="h1 txt-bold" id="banner_title">市場快訊</h2>
            <h5></h5>
        </div>
    </div>
</div>
    <div class="page_tabs">
        	        <a href="market_dailyreport.php?data_type=6" class="tab ">
	            <h5 class="txt-theme">投資日報</h5>
	        </a>
          	        <a href="market_weeklyreport.php?data_type=7" class="tab active">
	            <h5 class="txt-theme">全球市場周報</h5>
	        </a>
          	        <a href="market_outlook.php?data_type=8" class="tab ">
	            <h5 class="txt-theme">投資季展望</h5>
	        </a>
                  <!-- <a href="#" class="tab">
            <h5 class="txt-theme">全球市場周報</h5>
        </a>
        ...
        <div class="w1200">
            <form class="inner" id="form1" name="form1">
                ...
                <div class="col col33 btnset txt-right">
                    <p style="opacity: 0;">.</p>
                    <div>
                        <button class="clear" type="button" id="clear_date">
                            <p>
                                清除篩選
                            </p>
                            <img src="img/public/close.svg" alt="">
                ...
                <input type="hidden" name="data_type" id="data_type" value="7">
            </form>
        </div>
    </div>
        ...
        <div class="inner w1200">
            <div class="itembox" id="show_list">
                <!-- <a href="#" download class="item">
                    <p class="date txt-orange">
                        2021.08.12
                    </p>
                    <div class="text">
                        <h5 class="txt-bold txt-theme">
                            富盛全球市場日報
                        </h5>
                        <p class="">
                            美股上漲，核心CPI增幅符合預期，小型企業信心下滑。歐、日股上漲，德國及日本諮商會領先指標均攀升。新興市場、陸股下跌，港股上漲，巴西CPI持續攀升，澳洲消費者信心再度回落，南韓失業率…
                        </p>
                    </div>
            ...
            <div class="txt-center">
                <button class="btn-bor" id="get_more" style="display: none;">
                    了解更多
    ...
    <div class="content w1400">
        ...
        <div class="content_bottom">
            <div class="item">
                ...
                <p>客服信箱：<a href="/cdn-cgi/l/email-protection#2a594f585c43494f6a494d5943494f04494547" class="txt-orange"><span class="__cf_email__" data-cfemail="f7849285819e9492b79490849e9492d994989a">[email&#160;protected]</span></a></p>
...
<script type="text/javascript">
	...
	$("body").on("click","#send_btn",function(){
		...
		if(more_btn!="Y")$("#page").val("1");
		var page=$("#page").val();
		var data_type=$("#data_type").val();
		var startdate=$("#startdate").val();
		var enddate=$("#enddate").val();
		$.post("get_market_list.php",{page:page,data_type:data_type,startdate:startdate,enddate:enddate},function(data){
			d=JSON.parse(data);
			if(d["content"])
			{
				if(more_btn=="Y")

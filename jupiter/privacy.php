...
<link rel='canonical' href='https://www.cgsice.com/jupiter/privacy.php' />
<link rel='shortlink' href='' />
	<title>隱私權政策｜Jupiter先機</title>
  <meta name='title' content='隱私權政策｜Jupiter先機' />
	<meta name='description' content='' />
	<meta name='keywords' content='' />
	<meta name='sitecode' content='zh-TW'> <!--動態產生-->

	<!--Line-->
	<meta itemprop='name' content='隱私權政策｜Jupiter先機'>
	<meta itemprop='url' content='https://www.cgsice.com/jupiter/privacy.php'>
	...
	<!--FB-->
	<meta property='og:title' content='隱私權政策｜Jupiter先機'>
	<meta property='og:type' content='website'>	
	<meta property='og:url' content='https://www.cgsice.com/jupiter/privacy.php'>
...
<script src="js/main.js" defer></script>    <link rel="stylesheet" href="css/announcement.css?ver=1639710965">
</head>
<body>
    <div id="header_outer">
    <header>
...
</div>    <div id="banner" style="background-image: url(img/announcement/01_banner.jpg);">
    ...
    <div class="inner w1200 txt-white">
        <div class="text">
            <h2 class="h1 txt-bold" id="banner_title">隱私權保護</h2>
            <h5></h5>
        </div>
    </div>
</div>
    <div class="main_padding">
        <div class="w1200">
            <h5>
                親愛的客戶，歡迎您光臨富盛證券投資顧問股份有限公司官方網站（以下簡稱本網站），基於保護及尊重您的隱私權，讓您能夠安心使用本網站所為您提供之各項服務，且同意本網站於必要時記錄、蒐集、使用或處理您所提供之個人資料，俾便本網站能提供您更完善、貼心的服務。謹為如後之聲明： 
            </h5>
            <br><br>
            <h4 class="txt-theme">
                壹、個人資料之蒐集
            ...
            <br>
            <h5>
                1. 當您利用本網站查詢、搜尋各類資訊，或參加本網站所舉辦之各項活動，或登錄成為本網站會員時，我 們會依服務類型之需要請您提供您的個人資料，如：中、英文姓名（公司名稱）、身分證字號（統一編號）、出生日期、電話、電子信箱、住址其及它相關資料。並 利用防火牆、資料加密和身份驗證等三重保障，嚴密防護您的個人資料不外漏。 
                <br><br>
                2. 當您在瀏覽本網站時，本網站之伺服器會自動記錄並保留您的相關動向，例如IP位址（IP即網際網路通訊協定）、使用時間、使用的瀏覽器、瀏覽及點選的資料、網頁及其項目等。提醒您，當您利用本網站所提供之連結而瀏覽本網站以外之其他網站時，該網站亦有可能蒐集您的個人資料，請您務必注意並詳閱該網站就隱私權保護之相關措施。對於這些連結網站所為之資料蒐集、運用及處理，不適用本網站隱私權保護聲明。 
                <br><br>
                3. 對於您所提供之資料有不正確之情形，或於本網站之開放區域中（例如基金Q）所提供之個人資料，不適用本網站隱私權保護聲明。 
            </h5>
            <br><br>
            <h4 class="txt-theme">
                貳、傳送商業資訊
            ...
            <br>
            <h5>
                本網站於傳輸商業性資訊之電子郵件給您時，將同時於該電子郵件內註明係由本網站寄送。 
            </h5>
            <br><br>
            <h4 class="txt-theme">
                參、Cookies的運用
            ...
            <br>
            <h5>
                本網站於以下情形，會在您的瀏覽器中寫入並讀取Cookies： 
                <br><br>
                1. 作為本網站設計各項活動型態及其內容（例如，抽獎活動之獲獎通知與身份確認）之參考。 
                <br><br>
                2. 為提供更具人性化與個人化的服務，同時更便利您參與各類型活動。Cookies只在您第一次進入本網站時建立。（按：Cookies係伺服端針對使用者的不同需求，經由瀏覽器寫入使用者硬碟的若干簡短資訊。您可以透過Netscape 中之「功能設定」的「進階」或Internet Explorer之「Internet選項」的「安全性」中，選擇修改您的瀏覽器對於Cookies 的接受程度，其接受程度之修改類型共有三種，即「接受所有Cookies」、「設定Cookies時得到通知」、「拒絕所有Cookies」。倘若您選擇拒絕所有的Cookies，於此情形下您有可能無法使用部份個人化服務或參與部份活動。） 
            </h5>
            <br><br>
            <h4 class="txt-theme">
                肆、您的自我保護措施
            ...
            <br>
            <h5>
                1. 敬請您謹慎保管您的個人帳號、密碼及其他個人資料，切勿將個人之任何資料，尤其是帳號及密碼提供給第三人，本網站亦不會主動以任何方式詢問您的帳號及密碼。 
                <br><br>
                2. 當您以會員身份登入本網站並於用畢本網站所提供的各項服務後，請您務必要進行會員登出之步驟，尤其是在您的電腦設為與他人共享或使用公用電腦之情形下，切記要關閉瀏覽器視窗，以防止他人讀取您的個人資料或信件。更多網路安全必備守則。 
                <br><br>
                *您的資料將提供予富盛證券投資顧問股份有限公司，使富盛證券投資顧問股份有限公司就證券投資有關事項之研究分析意見、推介建議、基金投資相關訊息或其他事項提供予您。
            </h5>
        </div>
        <br>
        <br>
        <div class="w1200">
            <div class="txt-center">
                <a href="index.php" class="btn-bor">
                    回上一頁
    ...
    <div class="content w1400">
        ...
        <div class="content_bottom">
            <div class="item">
                ...
                <p>客服信箱：<a href="/cdn-cgi/l/email-protection#8bf8eef9fde2e8eecbe8ecf8e2e8eea5e8e4e6" class="txt-orange"><span class="__cf_email__" data-cfemail="ff8c9a8d89969c9abf9c988c969c9ad19c9092">[email&#160;protected]</span></a></p>

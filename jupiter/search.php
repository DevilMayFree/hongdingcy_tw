...
<link rel='canonical' href='https://www.cgsice.com/jupiter/search.php' />
...
<body>
    ...
    <div class="inner w1200 txt-white">
        <div class="text">
            <h2 class="h1 txt-bold" id="banner_title">搜尋結果</h2>
            <h5></h5>
        </div>
    </div>
</div>		<div class="page_filter main_padding">
		<div class="w1200">
			<form class="inner" name="form1" id="form1" method="post">
				<div class="col col33">
				...
				<div class="col col33">
					<p class="txt-bold txt-orange">
						投資標的
						<span class="small txt-medium txt-dark">
							<span id="invest_target_select_amount">0</span>/<span id="invest_target_total_amount">2</span>
						</span>
					</p>
					<select name="invest_target[]" id="invest_target" multiple="multiple" class="multiple-select" placeholder="請選擇投資標的">
													<option value="股票" >股票</option>
														<option value="債券" >債券</option>
												</select>
				</div>
				...
				<div class="col col100 btnset txt-right">
					...
					<div>
						...
						<button class="btn txt-white txt-bold h6" type="button" id="send_btn">
							搜尋
						</button>
					</div>
				</div>
    ...
    <div class="content w1400">
        ...
        <div class="content_bottom">
            <div class="item">
                ...
                <p>客服信箱：<a href="/cdn-cgi/l/email-protection#82f1e7f0f4ebe1e7c2e1e5f1ebe1e7ace1edef" class="txt-orange"><span class="__cf_email__" data-cfemail="c4b7a1b6b2ada7a184a7a3b7ada7a1eaa7aba9">[email&#160;protected]</span></a></p>
...
<script>
	...
	$("body").on("click","#send_btn",function(){
		...
		$.post("get_search.php",data,function(data){
			d=JSON.parse(data);
			if(d["content"])
			{
				if(more_btn=="Y")
	...
	$("#clear_data_btn").click(function(){
		...
		$('#invest_target').multipleSelect("uncheckAll");
